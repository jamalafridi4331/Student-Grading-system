...
data = pd.read_csv('SCHOOL MARKSHEET.csv')
data1 =  pd.read_csv("school marksheet_11a.csv")
data2 = pd.read_csv("school marksheet_11B.csv")
...
with st.sidebar:
    image_univ = Image.open("logo.jpeg")
...
if selectbox == "About School":
    with st.sidebar:
      ...
      image = Image.open("OIP.jfif")
      st.image(image,use_column_width = True)

      image = Image.open("OIP (1).jfif")
      st.image(image,use_column_width = True)
      
      image = Image.open("OIP (2).jfif")
      st.image(image,use_column_width = True)
